...
public class MenuManager : MonoBehaviour
{
    ...
    {
        // 연결 종료 이유를 가져옴
        var disconnetReason = NetworkManager.Singleton.DisconnectReason;
        infoText.text = disconnetReason;
        Debug.Log(disconnetReason);
    }
    ...
    public void CreateGameAsHost()
    {
        ...
        // 사용할 포트 번호 지정
        transport.ConnectionData.Port = DefaultPort; // 7777
